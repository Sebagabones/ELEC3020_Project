...
\usepackage{upquote}
\usepackage{fvextra}
\usepackage[latte,styleAll]{catppuccinpalette} \setlength{\parindent}{0pt}  \usepackage{hyperref} \usepackage{scrextend} \usepackage{fvextra} \usepackage{upquote} \usepackage{xcolor}  \hypersetup{colorlinks=false, hidelinks=true} \usepackage{circuitikz} \usepackage{rotating} \usepackage{geometry}  \newgeometry{vmargin={17mm}, hmargin={19mm,19mm}}   % set the margins
...
\label{sec:org79c8bc1}
\section*{{\color{CtpPink} Team-27 }}
\label{sec:orge3676e9}
...
\end{tikzpicture}
\end{turn}
\subsection*{Team Member Reports:}
\label{sec:org043978b}
\end{document}
