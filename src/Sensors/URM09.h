/*!
 * @file URM09.h
 * @brief Basic structure of URM09 class
...
public:
   ...
   * @fn begin
   * @brief Init i2c
   * @param address i2c device number (1-127), default to 0x11 when no device
   * number is uploaded
   ...
   * @param mode is measurement mode, automatic measurement and passive
   * measurement.
   ...
   * @n For example: if the read value is 0x00fe, the actual temperature will be
   * 0x00fe / 10 = 25.4
   * @return None
   */
